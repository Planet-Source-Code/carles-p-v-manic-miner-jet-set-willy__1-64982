...
Public Sub FXCrumblingBlock( _
           DIB As cDIB08, _
           ByVal x As Long, _
           ByVal y As Long, _
           ByVal IdxBack As Byte, _
           ByRef Cleared As Boolean _
           )
  ...
  Dim j2 As Long
    ...
    If (y >= 0 And y < DIB.Size - 8 * s - 7) Then

        Call MapDIBitsByte(SA1, a(), DIB)

        For j = j2 To j1 Step -s
            For i = j To j + 7
                a(i) = a(i - s)
            Next i
        Next j
